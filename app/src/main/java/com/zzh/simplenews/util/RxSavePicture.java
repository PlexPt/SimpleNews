...
public class RxSavePicture {
   ...
   public static Observable<Uri> savePicture(final Context context, final String url, final String title){
       return Observable.create(new Observable.OnSubscribe<Bitmap>() {
           ...
           public void call(Subscriber<? super Bitmap> subscriber) {
               ...
               if (bitmap == null){
                   subscriber.onError(new Exception("can not downLoad picture"));
               }
